      ...
      <div ref={veilleTitreRef} className='h-screen w-screen bg-transparent md:flex hidden justify-center items-center -z-20 overflow-x-hidden'>
       ...
       <ChangeNavColor>
        <div className='h-fit w-screen pb-80 flex flex-col justify-center overflow-x-hidden bg-black text-white md:-mt-100'>
                ...
                <div className='md:hidden flex justify-center items-center px-5 text-center  pt-10'>
                      <h1 className='text-6xl font-black py-10  w-1/2'>Ma Veille technologique</h1>
                  </div>
           ...
           {/*vidéo d'intro */}
             ...
             {/*Description de la veille*/}
              <section className='h-fit  items-center justify-center text-center font-mono md:px-40 py-20'>
                <Reveal>
                  <p>
              ...
              {/*Toutes les News  */}
                <section className='p-20 h-fit w-screen bg-black '>
                  {/*Titre de la section */}
                   <div>
